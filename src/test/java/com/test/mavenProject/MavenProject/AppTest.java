 ...
 *//**
	 ...
	 *//*
		 ...
		 * ); //System.out.println(searchResult.issues); List<Issue> listOfIssues =
		 * searchResult.issues; for(Issue issue:listOfIssues) {
		 * System.out.println("Issue-->"+issue); }
		 * //System.out.println(Issue.getBaseUri());
		 * //System.out.println(jira.getIssue("MavenProject")); //CZApiCycleClient zapi
		 * = new CZApiCycleClient(); //zapi.getCycleById(1); //RestClient restClient =
		 ...
		 * ); //System.out.println(searchResult.issues); List<Issue> listOfIssues =
		 * searchResult.issues; for(Issue issue:listOfIssues) {
		 * System.out.println("Issue in cycle:-->"+issue); } //issue. //List<String>
		 * str=(List<String>) jira.getRestClient().post(
		 * "https://seleniumjenkins.atlassian.net/rest/zapi/latest/execution?projectId=\"MAV\""
